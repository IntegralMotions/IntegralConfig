...
static std::vector<uint8_t> bytes_float_case1 = {0x82, 0xA3, 0x66, 0x33, 0x32, 0xCA, 0x40, 0x49, 0x0F, 0xD0, 0xA3, 0x66,
                                                 0x36, 0x34, 0xCB, 0xC1, 0xD2, 0x54, 0x13, 0xE0, 0x00, 0x00, 0x00};

static std::vector<uint8_t> bytes_float_case2 = {0x82, 0xA3, 0x66, 0x33, 0x32, 0xCA, 0xBF, 0xE0, 0x00, 0x00, 0xA3, 0x66,
...
INSTANTIATE_TEST_SUITE_P(MPackFloatsWrite, ObjectWithFloatsWriteTest,
                         ::testing::Values(FloatWriteCase{"FloatCase1", bytes_float_case1, 3.14159f, -1.23e9},
