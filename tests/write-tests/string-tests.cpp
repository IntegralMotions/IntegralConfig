...
INSTANTIATE_TEST_SUITE_P(MPackStringsWrite, ObjectWithStringsWriteTest,
                         ::testing::Values(StringWriteCase{"StringCase1", bytes_string_case1, "hello", "world", ""},
                                           StringWriteCase{"StringCase2", bytes_string_case2, "UTF-8 ✓",
