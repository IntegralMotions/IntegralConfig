...
class ObjectWithArrays : public MPackObject<ObjectWithArrays> {
  public:
    ...
    void registerMembers() {
        ...
        registerMember("aa_f64", {CppType::Array, {CppType::Array, CppType::F64}}, &aa_f64);
        registerMember("aa_bool", {CppType::Array, {CppType::Array, CppType::Bool}}, &aa_bool);
        registerMember("aa_objs", {CppType::Array, {CppType::Array, CppType::ObjectPtr}}, &aa_objs);
        registerMember("aa_ss", {CppType::Array, {CppType::Array, CppType::String}}, &aa_ss);
        registerMember("aaa_f32", {CppType::Array, {CppType::Array, {CppType::Array, CppType::F32}}}, &aaa_f32);
    }

  private:
    MPackObjectBase* createObject(const char*) override {
        return new Elem();
    }
};